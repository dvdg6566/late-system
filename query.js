document.getElementById('query-submit').addEventListener('click', (e) => {
    ...
    fetch('http://localhost:5000/query', {
        ...
        document.getElementById('holder').setAttribute("style", "border-color: #fff")
        setTimeout(() => {
            x = '<div id="first_col" style="width: 50%; float:left;"><div id="first_append" style="font-weight: 900; font-size: 0.5em; margin-bottom: 1em; margin-left: 30.8px;">Number of times student is late</div></div> <div id="second_col" style="width: 50%; float:left;"><div id="second_append" style="font-weight: 900; font-size: 0.5em; margin-bottom: 1em; margin-left: 30.8px;">Student Name</div></div> <div id="third_col" style="width: 50%; float:left;"><div id="third_append" style="font-weight: 900; font-size: 0.5em; margin-bottom: 1em; margin-left: 30.8px;">Student Class</div></div>'
